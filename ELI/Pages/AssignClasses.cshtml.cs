...
namespace ELI.Pages
{
     ...
     * functionality 
     * **/
    public class AssignClassesModel : EliPageModel
    {
        //private readonly ELIContext _context;

        public AssignClassesModel(ELIContext context, IConfiguration config, ILogger<StudentSearchModel> logger) : base(context, config, logger){}
